...
def generate_insert_statements(table, num_rows=10000):
    ...
    for _ in range(num_rows):
        if table == 'company_specialisation':
        ...
        elif table == 'user_spacesuit_data':
            insert_statements.append(f"INSERT INTO user_spacesuit_data (head, chest, waist, hips, foot_size, height, fabric_texture_id) VALUES "
                                    ...
                                    f"{random.randint(1, 100)}, {random.randint(1, 100)}, {random.randint(1, 300)}, {random.randint(1, 100)});")
...
# Example usage
tables = [
    # 'company_specialisation', 'science_lab', 'lab_request', 'company_request',
    # 'company', 'fabric_texture', 'user_spacesuit_data', 'user_request',
    # 'staff_request', 'staff',
    'user_data'
    # , 'users', 'additional_char'
]
